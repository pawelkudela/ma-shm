...
%% input for figures
selected_frames = [65,129,193,257,321,385];
ColorMapName = 'jet';
...
figure_output_folder = [figure_output_path,num2str(test_case),'_output',filesep];
      ...
      if(overwrite||(~overwrite && ~exist([figure_output_folder], 'dir')))
            ...
            plot_meshgrid_frames_time(Data_quarter,t_frames,'bottom',test_case,selected_frames,figure_output_folder,normalization,caxis_cut,ColorMapName,'velocity',3,fig_width,fig_height);
