function plot_meshgrid_frames_time_3D(Data,time, shell_surface,test_case,selected_frames,figure_output_path,normalization,caxis_cut,ColorMapName,field_variable,motion,fig_width,fig_height)
% PLOT_MESHGRID_FRAMES_TIME_3D   plot selected frames of wavefield 
...
% 
% Syntax: plot_meshgrid_frames_time_3D(Data,time, shell_surface,test_case,selected_frames,figure_output_path,normalization,caxis_cut,ColorMapName,field_variable,motion,fig_width,fig_height)
% 
% Inputs: 
...
% 
% Other m-files required: solid3D_variable_names.m
% Subfunctions: none 
