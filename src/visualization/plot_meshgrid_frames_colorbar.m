function plot_meshgrid_frames_colorbar(Data,shell_surface,test_case,selected_frames,figure_output_path,normalization,caxis_cut,ColorMapName,field_variable,motion,fig_width,fig_height)
% PLOT_MESHGRID_FRAMES_COLORBAR   plot selected frames of wavefield with colorbar
%    wavefield is defined on regular grid of points (meshgrid)
%    frames are saved as png images 
% 
% Syntax: plot_meshgrid_frames_colorbar(Data,test_case,selected_frames,figure_output_path,normalization,caxis_cut,ColorMapName,field_variable,motion)
% 
% Inputs: 
...
% 
% Example: 
%    plot_meshgrid_frames_colorbar(Data,test_case,selected_frames,figure_output_path,normalization,caxis_cut,ColorMapName,field_variable,motion)
%    plot_meshgrid_frames_colorbar(Data,test_case,selected_frames,figure_output_path,1,0.5,'jet','displacement',3)
% 
...
% ================ [plot_meshgrid_frames_colorbar.m] ================  
