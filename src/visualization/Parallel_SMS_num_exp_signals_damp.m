...
Smax=max(max(abs(sA_num)));
Smin=-Smax;
axis([0 time(256) Smin Smax]);
set(gcf,'color','white');
set(gca,'Fontsize',10,'linewidth',1);
set(gca,'FontName','Times');
ylabel('A [mm/s]','Fontsize',11);
...
lg=legend([hp{1},hp{2}],{['$\alpha =$ ',num2str(alphaz(1))],['$\alpha =$ ',num2str(alphaz(2))]},'Fontsize',9,'interpreter','latex','Location','NorthOutside');
legend boxoff;
...
hLeg=legend([hp{3},hp{4}],{['$\alpha =$ ',num2str(alphaz(3))],'experiment'},'Fontsize',9,'interpreter','latex','Location','NorthOutside');
...
%set(hLeg,'visible','off')
legend boxoff;
axis([440 455 0.3*Smin 0.3*Smax]);
xlabel({['t [','$\mu$','s]']},'Fontsize',11,'interpreter','latex');
ylabel('A [mm/s]','Fontsize',11);
set(gca,'Fontsize',10,'linewidth',1);
set(gca,'FontName','Times');
