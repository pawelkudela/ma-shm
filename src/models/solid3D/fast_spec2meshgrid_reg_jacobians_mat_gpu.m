...
switch surface
   case 'bottom'
      ZA=Uz(nodes(ownerElement,1:NofElNodesx*NofElNodesy))'; % bottom surface
   case 'top'
      ZA=Uz(nodes(ownerElement,NofElNodesx*NofElNodesy*nz-NofElNodesx*NofElNodesy+1:NofElNodesx*NofElNodesy*nz))'; % top surface
   case 'middle'
      ZA=Uz(nodes(ownerElement,NofElNodesx*NofElNodesy*nz-NofElNodesx*NofElNodesy+1:NofElNodesx*NofElNodesy*nz))'; % middle surface
end
% c=0;
% for j =1:Ny
%     for i=1:Nx
