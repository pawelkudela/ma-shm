...
surface='top'; % options surface='top';surface='bottom';surface='middle';

os='win';
switch os
    case 'win'
        eval(['run inputs\input',num2str(k_test)]); 
        data_filename=['outputs\output',num2str(k_test),'\plate_in_plane_',num2str(k_test),'_',num2str(Nx),'x',num2str(Ny),surface,'.mat'];
    case 'linux'
        eval(['run inputs/input',num2str(k_test)]); 
	 data_filename=['outputs/output',num2str(k_test),'/plate_in_plane_',num2str(k_test),'_',num2str(Nx),'x',num2str(Ny),surface,'.mat'];
