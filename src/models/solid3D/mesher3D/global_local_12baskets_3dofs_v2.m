function [I_G_dofs,I_L_dofs] = global_local_12baskets_3dofs_v2(I_G,I_L,mode)
% GLOBAL_LOCAL_12BASKETS_3DOFS_v2   convert nodal numbers into degrees of freedom numbers 
% 
% Syntax: [I_G_dofs,I_L_dofs] = global_local_12baskets_3dofs_v2(I_G,I_L,mode)
% 
% Inputs: 
...
% ================ [global_local_12baskets_3dofs_v2.m] ================  
