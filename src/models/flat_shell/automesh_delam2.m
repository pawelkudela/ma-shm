        ...
        for ib=1:length(b_set)
            ...
            for ia=1:length(a_set)
                ...
                if(a == b)
                    counter = counter + 1;
                    rotAngle = 0;
                    mesh_filename = ['m2_',num2str(counter),'_delam1_position_no_',num2str(position_no),'_a_',num2str(a*1e3),'mm_b_',num2str(b*1e3),'mm_angle_',num2str(rotAngle)]; 
                    ...
                    for irot = 1:length(rotAngle_set) % rotation angle
                        ...
                        mesh_filename = ['m2_',num2str(counter),'_delam1_position_no_',num2str(position_no),'_a_',num2str(a*1e3),'mm_b_',num2str(b*1e3),'mm_angle_',num2str(rotAngle)]; % a, b in mm                       
                        mesh_parameters(counter).position_no = position_no;
                        mesh_parameters(counter).xCenter = xCenter;
                        mesh_parameters(counter).yCenter = yCenter;
                        mesh_parameters(counter).a = a;
