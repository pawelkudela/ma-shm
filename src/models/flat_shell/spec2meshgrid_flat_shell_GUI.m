function [Data] = spec2meshgrid_flat_shell_GUI(app,AllData_filename,field_variable,motion,shell_surface)
% SPEC2MESHGRID_FLAT_SHELL_GUI   Interpolate wavefield on uniform grid 
%    wavefield is spanned on a spectral element mesh 
%    uniform mesh is created by using meshgrid  
% 
% Syntax: [Data] = spec2meshgrid_flat_shell_GUI(test_case,meshfile,Nx,Ny,field_variable,motion,shell_surface,output_name) 
% 
% Inputs: 
...
% 
% Example: 
%    [Data] = spec2meshgrid_flat_shell_GUI(test_case,meshfile,Nx,Ny,field_variable,motion,shell_surface) 
%    [Data] = spec2meshgrid_flat_shell_GUI(test_case,meshfile,Nx,Ny,'displacement',1,'top') 
%    [Data] = spec2meshgrid_flat_shell_GUI(test_case,meshfile,Nx,Ny,'velocity',4,'bottom') 
% 
...
input_path = prepare_model_paths('raw','num','flat_shell','GUI');
input_name = [input_path,filesep,AllData.Filename,filesep];
...
data_filename=fullfile(output_name,['\flat_shell_',variable_name,'_',AllData.Filename,'_',num2str(Nx),'x',num2str(Ny),shell_surface,'.mat']);
% corner nodes
...
% ================ [spec2meshgrid_flat_shell_GUI.m] ================  
