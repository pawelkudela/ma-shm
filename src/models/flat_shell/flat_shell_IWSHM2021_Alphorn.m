...
for test_case=tasks
    ...
    if(overwrite||(~overwrite && ~exist([output_name,'time',num2str(test_case),'.mat'],'file')))
        ...
        try
            ...
            [Data] = spec2meshgrid_flat_shell(test_case,input_no,meshfile{test_case},Nx,Ny,'velocity',3,'bottom',output_name,interim_output_name); % Vz
            plot_meshgrid_frames_time(Data,t_frames,'bottom',test_case,selected_frames,figure_output_name,normalization,caxis_cut,ColorMapName,'velocity',3,fig_width,fig_height);
            [Data] = spec2meshgrid_flat_shell(test_case,input_no,meshfile{test_case},Nx,Ny,'velocity',3,'top',output_name,interim_output_name); % Vz
            plot_meshgrid_frames_time(Data,t_frames,'top',test_case,selected_frames,figure_output_name,normalization,caxis_cut,ColorMapName,'velocity',3,fig_width,fig_height);
            
            
            [Data] = spec2meshgrid_flat_shell(test_case,input_no,meshfile{test_case},Nx,Ny,'velocity',9,'bottom',output_name,interim_output_name); % Amplitude
            plot_meshgrid_frames_time(Data,t_frames,'bottom',test_case,selected_frames,figure_output_name,normalization,caxis_cut,ColorMapName,'velocity',9,fig_width,fig_height);
            [Data] = spec2meshgrid_flat_shell(test_case,input_no,meshfile{test_case},Nx,Ny,'velocity',9,'top',output_name,interim_output_name); % Amplitude
            plot_meshgrid_frames_time(Data,t_frames,'top',test_case,selected_frames,figure_output_name,normalization,caxis_cut,ColorMapName,'velocity',9,fig_width,fig_height);
