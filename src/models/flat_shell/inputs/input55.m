...
%% plate Alphorn glass-epoxy
%% Signal definition
tt= 8e-04;          % total calculation time [s] % time(1024)
nFrames_exp = 1024; % number of time steps taken from experiment
dt_exp = tt/(nFrames_exp-1); % time step in experiment
division = 2^7;% number of divisions of experimental time step
...
f_1=50e3/3;        % frequency of the modulation signal [Hz]
f_2=3*f_1;          % frequency of the carrier signal [Hz]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
'plate thickness [m]';                         lh = [1,1,1,1]*4/4/1000; % 4 mm total thickness
'stack angle sequence [deg]';              lalpha = [45,-45,45,-45];
