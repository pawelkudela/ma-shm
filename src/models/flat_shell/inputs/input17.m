...
nft=200000;      % total number of samples
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% fibres(3) - carbon fiber semi-optimized
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
'plate thickness [m]';                         lh = [1,1,1,1,1,1,1,1]*3/8/1000; % 3 mm total thickness
'stack angle sequence [deg]';              lalpha = [0 90 0 90 90 0 90 0];
'stack matrix sequnce';                       lmat = [5,5,5,5,5,5,5,5];
'stack fibres sequece';                        lfib = [3,3,3,3,3,3,3,3];
'volume fraction of fibres';                   lvol=[0.44,0.44,0.44,0.44,0.44,0.44,0.44,0.44]; 
