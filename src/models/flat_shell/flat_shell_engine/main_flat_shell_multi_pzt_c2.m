function t_frames=main_flat_shell_multi_pzt_c2(actuator_no,test_case,input_no,meshfile,mode,output_name,tasks)
% MAIN_FLAT_SHELL_MULTI_PZT_C2   Compute wavefield by using flat shell spectral elements and c tensor for material prop 
% 
% Syntax: main_flat_shell_multi_pzt_c2(test_case,meshfile,mode,output_name)
% 
% Inputs: 
...
% Example: 
%    main_flat_shell_multi_pzt_c2(test_case,meshfile,mode,output_name)
%    main_flat_shell_multi_pzt_c2(1,'mesh1','gpu',output_name) 
% 
