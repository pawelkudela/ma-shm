function [nodes,coords,den_under,den_above,I_G,I_L] =automesh_multi_pzt_complex_3d(nPZT,shape_order,mesh_filename,modelfolder,figfilename,isDelamOn)
% AUTOMESH_MULTI_PZT_COMPLEX_3D   automatic mesh generation including 1 delamination region based on geo file
%    for the case of multi pzts and multi materials (rivets); it uses gmsh external software 
% 
% Syntax: [nodes,coords,den_under,den_above,I_G,I_L] =automesh_multi_pzt_complex_3d(mesh_filename,modelfolder,figfilename)
% 
% Inputs: 
...
% 
% Example: 
%    [nodes,coords,den_under,den_above,I_G,I_L] =automesh_multi_pzt_complex_3d(mesh_filename,modelfolder,figfilename)
% 
...
save([spec_mesh_output_path,mesh_filename,'.mat'],'nodes','coords','pztEl','delamEl','I_G','I_L','mesh_min','mesh_max','shape_order','den_under','den_above','msh');
