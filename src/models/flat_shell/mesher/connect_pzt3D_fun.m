function [nodes,coords]=connect_pzt3D_fun(NofElNodesx,NofElNodesy,NofElNodesz,pztEl,nodes,pqs,pzt_t)
...
cc=0;
 if(isempty(pztEl))
     ...
     for m=1:npzt
         ne=pztEl(m);
         c=c+1;
         nodespztlay=[nodespztlay,nodes(ne,(NofElNodesz-1)*NofElNodesx*NofElNodesy+1:NofElNodesx*NofElNodesy*NofElNodesz)];
         nodespzt(c,1:NofElNodesx*NofElNodesy)=nodes(ne,(NofElNodesz-1)*NofElNodesx*NofElNodesy+1:NofElNodesx*NofElNodesy*NofElNodesz);
     end
