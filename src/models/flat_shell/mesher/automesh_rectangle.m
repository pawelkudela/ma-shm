function [nodes,coords,I_G,I_L] = automesh_rectangle(shape_order,mesh_filename,modelfolder,figfilename)
% AUTOMESH_RECTANGLE   automatic mesh generation of uniform mesh based on geo file
%    it uses gmsh external software 
% 
% Syntax: [nodes,coords,I_G,I_L] = automesh_rectangle(shape_order,mesh_filename,modelfolder,figfilename)
% 
% Inputs: 
...
% geo-files required: rect*.geo in geo folder
% See also:
% 
...
save([spec_mesh_output_path,mesh_filename,'.mat'],'nodes','coords','I_G','I_L','mesh_min','mesh_max','shape_order');
