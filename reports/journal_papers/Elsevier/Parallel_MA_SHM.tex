...
\begin{document}
   ...
   \clearpage
	...
	\begin{figure} [h!]
		...
		\end{subfigure}
		\caption{Comparison of numerical full wavefield data at the top surface of the plate for two defect modelling techniques: delamination and added mass.} 
		\label{fig:wave_entrapment}
	\end{figure}
\clearpage
\subsection{Comparison of signals}
The comparison of experimental and numerical signals for selected transducer pairs is presented in Figs.~\ref{fig:path1_7}--\ref{fig:path4_8}. The first wave packet in experimental signals should be ignored because it represents the effect of electromechanical crosstalk.

It should be added that the material damping is very important because it affects attenuation of guided wave modes and in turn particular wave packets in signals. In the current modelling approach, the damping coefficient was arbitrary selected. However, in future some optimization technique can be applied for finding damping coefficient so that the numerical signal best fit to experimental one. 
	\begin{figure} [h!]
			\centering
			%\includegraphics[width=\textwidth]{path_1_7.png}
			\includegraphics{path_1_7.png}	
			\caption{Comparison of experimental and numerical signals for transducer pairs 1--7}
			\label{fig:path1_7}
	\end{figure}
	\begin{figure} [h!]
		\centering
		...
		\caption{Comparison of experimental and numerical signals for transducer pairs 2--4}
		\label{fig:path2_4}
	\end{figure}
	\begin{figure} [h!]
		\centering
		...
		\caption{Comparison of experimental and numerical signals for transducer pairs 4--8}
		\label{fig:path4_8}
	\end{figure}
\clearpage
