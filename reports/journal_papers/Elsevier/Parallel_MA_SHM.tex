...
\begin{document}
	...
	\subsection{Delamination modelling}
   ...
   \end{figure}
	...
	\begin{figure} [h!]
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[]{cut_Vz_1_frame72_top.png} 
			\caption{Numerical simulation: $t=112.5  \mu$s}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[]{cut_Vz_1_frame108_top.png}
			\caption{Numerical simulation: $t=168.7 \mu$s}
